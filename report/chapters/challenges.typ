...
Le joueur·euse reçoit une information expliquant que l'hôpital subit une attaque par ransomware. Une mise en contexte est posée ainsi que le rôle qu'il va jouer : il incarne un membre d'une équipe d'intervention de cybersécurité appelée en urgence pour contenir l'attaque et récupérer les données volées par les cybercriminels au Centre Hospitalier Horizon Santé (Challenge 0 Intro).\
Après avoir retrouvé le courriel de phishing à l'origine de l'attaque (#link(<ch-1>)[Challenge 1 Mail Contagieux]), il découvre le domaine frauduleux et se lance dans l'exploration du portail d'exfiltration exploité par les assaillants (#link(<ch-2>)[Challenge 2 Portail Frauduleux]). Pour réussir à y pénétrer, il réalise une injection SQL pour contourner l'authentification et ouvrir une première session, mais seulement avec des droits visiteur, qui est suffisant pour naviguer et consulter les données volées, mais pas assez pour les supprimer du serveur des attaquants.\
...
"_Le Centre hospitalier Horizon Santé est un grand hôpital universitaire de la région. Il est le centre de référence pour les soins d'urgence, les soins intensifs et les interventions chirurgicales complexes. Il est également un centre de recherche médicale important. Le mardi 12 juillet 2025 à 12 h 32, une campagne de phishing ciblée a permis à un groupe de cybercriminels d'infiltrer le réseau. En quelques minutes, un ransomware a exfiltré puis chiffré les données des serveurs cliniques, pris le contrôle du réseau interne et provoqué un blackout des systèmes informatiques. Sans son système, l'hôpital ne peut plus fonctionner.\
Vous faites partie d'une équipe d'intervention de cybersécurité appelée en dernier recours. L'hôpital a isolé son réseau pour empêcher les attaquants d'agir davantage. Vous venez d'obtenir un accès d'urgence à ce réseau. Votre mission est de réussir à pénétrer dans le système des attaquants afin d'y supprimer les données sensibles qu'ils ont exfiltrées et les bloquer pour qu'ils ne puissent plus pénétrer dans le système.\
