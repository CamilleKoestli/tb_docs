...
Chaque des challenges explique plus en détail sur l'implémentation, ce qui est attendu du joueur·euse avec les consignes, les indices et les solutions attendues.
...
#table(
  ...
  [OSINT et forensic email],
  [Analyser les en-têtes d’un email de phishing pour identifier le domaine frauduleux utilisé par l’attaquant.],
...
Le joueur·euse a réussi à bloquer l'attaquant et à sécuriser le réseau de l'hôpital. La deuxième vague n'aura donc pas lieu et le joueur·euse reçoit une popup de fin pour conclure l'aventure.
...
// TODO à revoir
Le joueur·euse acquiert une petite compréhension des enjeux de la cybersécurité dans un environnement hospitalier. Ces challenges permettent de montrer l’importance de la détection rapide des menaces, de l’analyse technique des incidents, de la maîtrise des techniques d’intrusion comme des mesures de défense. Ce scénario permet également d’illustrer comment une attaque informatique peut avoir des conséquences directes sur la possibilité de réaliser des soins sécurisées aux personnes, et pourquoi la cybersécurité est aussi un élément crucial pour les infrastructures de santé.
