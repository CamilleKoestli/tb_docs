...
Le titre a du être remanié pour coller avec le scénario de l'histoire et donc porte le nom "Intrusion dans le _Centre Hospitalier Horizon Santé_". De ce fait, les anciens noms "Blackout" ont été remplacés par "Intrusion" dans tout le rapport mais le code source garde encore les anciens noms pour des raisons de simplicité.
...
//, qui sont suffisant pour naviguer et consulter les données volées, mais pas assez pour les supprimer du serveur des attaquants.\
...
Votre mission est de pénétrer dans le système des attaquants, supprimer les données sensibles qu'ils ont volées et les bloquer définitivement pour qu'ils ne puissent plus accéder au réseau de l'hôpital.\
Chaque minute compte. L'avenir des patients est entre vos mains._"
