...
Par la suite, les tests finaux ont révélé des différences assez importantes dans l'expérience utilisateur selon le niveau de compétence des participant·e·s. Les personnes avec des connaissances avancées en informatique ont généralement progressé de manière fluide à travers les premiers challenges, sans vraiment utilisé les indices. Elles ont confirmé l’intérêt du scénario et la pertinence technique des défis. Tandis que les participant·e·s débutant·e·s ont rencontré beaucoup plus de blocages, notamment dans la compréhension du vocabulaire technique, des concepts de base, du format de réponse attendu et ont relevé un manque de clarté sur les indices.

De manière générale, les tests montrent que le scénario est accessible à des débutants motivés tout en étant amusant pour des profils plus avancés. L’équilibre entre narration et techniques à utilisées a été jugé satisfaisant.
...
Malgré les difficultés rencontrées, ils ont exprimé une grande satisfaction lorsqu'ils réussissaient à résoudre un challenge, ce qui leur a permis de rester motivés et de progresser, même après plusieurs essais.
...
Le premier point concerne les indices et consignes. Certains indices ont été jugés trop complexes, ce qui rendait la compréhension difficile pour certain·e·s ou au contraire trop explicites et donc trop faciles. Le vocabulaire technique dans certaines consignes a aussi été un obstacle pour les débutant·e·s. Les joueur·euse·s devaient régulièrement trouver les informations dans la boîte à outils, ce qui a parfois interrompu le flux de jeu. Un dernier élément souligné par les participant·e·s a été aussi la boîte à outils, qui était jugée très dense et complexe, rendait la recherche d'informations trop difficile.
