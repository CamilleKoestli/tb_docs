...
Déguisé en consultant, le joueur, alias CipherFox, commence son infiltration depuis sa suite d’hôtel : il déchiffre le hash SHA-1 caché dans les métadonnées d’un PDF public pour deviner le mot de passe et se connecter au Wi-Fi invité de KeyWave Systems.
