...
=== Laboratoires et exercices pratiques <laboratoires-exercices>

*Public* : Étudiant·e·s en formation.
...
*Public* : Collaborateur·trice·s en entreprise, grand public.

*Objectifs* : Sensibilisation aux menaces courantes.
...
*Public* : Variable, du grand public aux utilisateur·trice·s avancé·e·s.
