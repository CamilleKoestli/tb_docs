= Propositions de nouveaux scénarios <scenarios>
Ce chapitre présente les différents scénarios imaginés pour la plateforme _CyberGame_. L'objectif était de trouver des histoires captivantes et pédagogiques tout en intégrant des éléments de jeu pour travailler les aspects de la cybersécurité. Pour réussir à trouver un scénario adapté, il a fallu s'inspirer de faits réels et de CTF afin d'imaginer les challenges. Les mécaniques de jeux et leurs objectifs pédagogiques ont été analysés. Ensuite, trois scénarios ont été élaborés, chacun avec ses propres défis et compétences visées tout en restant accessible à tout le monde. Chaque scénario est présenté avec une description détaillée, les compétences travaillées et les étapes pour le résoudre.
...
== Choix du scénario final <choix-scenario>
